...
The plugin-level half of [`../TESTING.md`](../TESTING.md) (its Layer 0 and
Layer 1), with the tools that run it. Three layers here, from safest to
most real; only move to the next when the previous one is clean.
