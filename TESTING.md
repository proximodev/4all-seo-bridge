...
| Yoast renders it | purge cache, view page source | `<title>` shows the new value (**answered 2026-09-12 locally:** it does, no indexable rebuild needed; re-confirm once on a client host) |
